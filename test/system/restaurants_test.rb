...
class RestaurantsTest < ApplicationSystemTestCase
  ...
  test "creating a Restaurant" do
    ...
    fill_in "Restaurant contactno", with: @restaurant.restaurant_contactNo
    fill_in "Restaurant name", with: @restaurant.restaurant_name
    fill_in "Restaurant status", with: @restaurant.restaurant_status
    fill_in "Restaurant timings", with: @restaurant.restaurant_timings
